...
class PlayList(APIMixin):
    ...
    def get_playlist_json(self, playlist_id):
        ...
        playlist_json = self.get_service().playlists().list(id=playlist_id,
    ...
    def get_playlist(self, playlist_id):
        playlist = self.get_playlist_json(playlist_id)["items"][0]
        return playlist

    def get_videos_by_playlist_id(self, playlist_id) -> dict:
